 ...
 * scaleattack" command will set whether or not a mob's attack  
 * should be scaled or not, given that the command was entered 
 * correctly and the sender has permission to use this command.
 * @author CJ McGuire
 */
public class ScaleAttackCommand extends AbstractScaleCommand
{
	/**
	 * The name of this command. ("scaleattack")
	 */
	public static final String NAME = "scaleattack";
	 ...
	 * the command.
	 */
	public static final String SELF_PERMISSION = "dynamic.scaleattack.self";
	
	/**
	 * The permission node to allow access to target others with the 
	 * command.
	 */
	public static final String OTHER_PERMISSION = "dynamic.scaleattack.other";
	
	private static final String SELF_DENY_PERMISSION_MESSAGE = "You do not have permission to turn mob attack scaling on or off for yourself";
	private static final String OTHER_DENY_PERMISSION_MESSAGE = "You do not have permission to turn mob attack scaling on or off for others";
	
	private static final String SELF_DENY_CONSOLE_MESSAGE = "You must be a player to turn mob attack scaling on or off for yourself";
	...
	private static final String ATTRIBUTE_NAME = "attack";
	
	/**
	 * Initializes this Command.
	 * @param server - the server to get players from
	 */
	public ScaleAttackCommand(Server server)
	{
		super(server,

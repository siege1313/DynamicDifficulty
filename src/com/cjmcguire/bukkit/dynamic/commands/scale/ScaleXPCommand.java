 ...
 * scalexp" command will set whether or not the xp that a mob drops  
 * should be scaled or not, given that the command was entered 
 * correctly and the sender has permission to use this command.
 * @author CJ McGuire
 */
public class ScaleXPCommand extends AbstractScaleCommand
{
	/**
	 * The name of this command. ("scalexp")
	 */
	public static final String NAME = "scalexp";
	 ...
	 * the command.
	 */
	public static final String SELF_PERMISSION = "dynamic.scalexp.self";
	
	/**
	 * The permission node to allow access to target others with the 
	 * command.
	 */
	public static final String OTHER_PERMISSION = "dynamic.scalexp.other";
	
	private static final String SELF_DENY_PERMISSION_MESSAGE = "You do not have permission to turn xp scaling on or off for yourself";
	private static final String OTHER_DENY_PERMISSION_MESSAGE = "You do not have permission to turn xp scaling on or off for others";
	
	private static final String SELF_DENY_CONSOLE_MESSAGE = "You must be a player to turn xp scaling on or off for yourself";
	...
	private static final String ATTRIBUTE_NAME = "xp";
	
	/**
	 * Initializes this Command.
	 * @param server - the server to get players from
	 */
	public ScaleXPCommand(Server server)
	{
		super(server,

...
public class ChangeLevelCommand extends PlayerTargetableCommand
{
	 ...
	 * is not a number. Second, the mob name is not a valid mob name. If any of 
	 * these conditions voccur, the method will not change the performance level 
	 * and will inform the sender of the error.
	 * @param sender the sender of the command
	 * @param playerName the name of the player
	 * @param args must contain "changelevel" in args[0], args[1] must contain 
	 * the mob name and args[2] must contain the level to change to. Optionally
